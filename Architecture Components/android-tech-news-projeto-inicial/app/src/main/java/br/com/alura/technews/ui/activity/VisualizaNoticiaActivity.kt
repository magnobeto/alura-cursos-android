...
import br.com.alura.technews.ui.viewmodel.factory.VisualizaNoticiasViewModelFactory
...
class VisualizaNoticiaActivity : AppCompatActivity() {
    ...
    private val viewModel by lazy {
        ...
        val factory = VisualizaNoticiasViewModelFactory(noticiaId, repository)
        ViewModelProvider(this, factory).get(VisualizaNoticiasViewModel::class.java)
    }
